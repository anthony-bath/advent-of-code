...
extension Year2023 {
  struct Day22: AdventDay {
    ...
    func getData() -> ([Year2023.Brick], [[[String]]]) {
      ...
      let bricks = lines.map { line -> Year2023.Brick in
        ...
        return Year2023.Brick((p1[0], p1[1], p1[2]), (p2[0], p2[1], p2[2]))
      }.sorted { b1, b2 in
    ...
    func drop(_ brick: Year2023.Brick, _ space: inout [[[String]]]) -> Bool {
      var dropped = false
    ...
    func canDrop(_ brick: Year2023.Brick, _ space: inout [[[String]]]) -> Bool {
      brick.updateSpace(&space, type: ".")

      let result = brick.p1.2 - 1 >= 1 && brick.p2.2 - 1 >= 1 && brick.points
        .allSatisfy { x, y, z in
          space[z - 1][y][x] == "."
        }
