...
You look up the support number for the manufacturer and give them a call. Good thing, too - that `49`th star wasn't going to earn itself.
...
For example, the `12`th code would be written to row `4`, column `2`; the `15`th code would be written to row `1`, column `5`.
