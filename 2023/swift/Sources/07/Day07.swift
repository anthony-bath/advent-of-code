...
struct Day07: AdventDay {
  ...
  func sortPlayers(_ p1: Player, _ p2: Player) -> Bool {
  ...
  func calculateWinnings(useJokers: Bool) -> Int {
    let handFactory = HandFactory(useJokers: useJokers)
    let playerFactory = PlayerFactory(handFactory: handFactory)
  ...
  func part1() -> Any {
    return calculateWinnings(useJokers: false)
  }

  func part2() -> Any {
    return calculateWinnings(useJokers: true)
  }
}
